...
<head>
   <!-- Required meta tags -->
    	<!--required meta tags-->
			<meta charset="UTF-8">
			<meta name="description" content="sample_website Register_page">
		...
		<!--page title-->
			<title>sample_site Register_page</title>
	...
	<nav class="navbar navbar-expand-sm bg-light navbar-light justify-content-end">
		...
		<div class="login">
			...
			<form class="form-horizontal" action="/action_page.php">
			  ...
			  <div class="form-group">
				<label class="control-label col-sm-5" for="pwd"><b>Confrim password</b></label>
				<div class="col-sm-10">
				  <input type="password" class="form-control form-control-lg" id="cpwd" required>
				</div>
			  </div>
